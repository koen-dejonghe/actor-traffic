...
class CelltowerDatabaseSpec extends FlatSpec with Matchers with LazyLogging {
    ...
    "The CelltowerDatabase" should "find all celltowers of a network" in {
        val result = CelltowerDatabase.findAllCelltowersForNetwork(206, 10)
    ...
    "The CelltowerDatabase" should "find the closest celltower" in {
        ...
        val result = CelltowerDatabase.findClosestCelltower(206, 10, LatLng(50.863573890059484, 4.329307330900974))

        result.area should be (16200)
        result.cell should be (12823)
